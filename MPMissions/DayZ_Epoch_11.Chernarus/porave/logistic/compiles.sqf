if (!isDedicated) then {
	...
	call compile preprocessFileLineNumbers "porave\logistic\config.sqf";
	call compile preprocessFileLineNumbers format ["porave\logistic\lang\%1_lang.sqf", LOG_CFG_lANG];

	MONI_OBJECT	= compile preprocessFileLineNumbers "porave\logistic\monitor\monitor_object.sqf";
	MONI_ACTION	= compile preprocessFileLineNumbers "porave\logistic\monitor\monitor_action.sqf";
	LOG_OBJ_INIT = compile preprocessFileLineNumbers "porave\logistic\object\init.sqf";
	LOG_LIFT_INIT = compile preprocessFileLineNumbers "porave\logistic\lift\init.sqf";
	LOG_TOW_INIT = compile preprocessFileLineNumbers "porave\logistic\tow\init.sqf";
