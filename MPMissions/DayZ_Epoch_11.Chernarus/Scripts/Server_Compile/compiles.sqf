...
if (!isDedicated) then {
	...
	player_unlockVault =			compile preprocessFileLineNumbers "Scripts\custom\player_unlockVault.sqf";
	...
	player_lockVault =			compile preprocessFileLineNumbers "Scripts\custom\player_lockVault.sqf";
	...
	vehicle_handleDamage =          compile preprocessFileLineNumbers "Scripts\CarFixxLock\vehicle_handleDamage.sqf";
